...
description: frontend, slides, create, stunning, animation-rich, html, presentations, scratch, converting, powerpoint
---
...
2. Generate **3 single-slide preview files** in `.design/slide-previews/`.
