...
export const PROVIDER_CAPABILITIES: Record<CLIProxyProvider, ProviderCapabilities> = {
  ...
  opencode: {
    ...
    authStartUnsupportedReason:
      'OpenCode Zen/Go uses API key authentication. Configure via AI Providers with your OpenCode API key from https://opencode.ai/auth',
  ...
  go: {
    displayName: 'Go CLI',
    description: 'Go command-line interface provider',
    oauthFlow: 'device_code',
    callbackPort: null,
    callbackProviderName: 'go',
    authUrlProviderName: 'go',
    refreshOwnership: 'unsupported',
    authStartSupport: 'unsupported',
