...
export const PROVIDER_CAPABILITIES: Record<CLIProxyProvider, ProviderCapabilities> = {
  ...
  zai: {
    ...
    description: 'Z.AI GLM-4 and GLM-5 models via ZCode OAuth',
    oauthFlow: 'device_code',
    callbackPort: null,
    callbackProviderName: 'zai',
    authUrlProviderName: 'zai',
    refreshOwnership: 'cliproxy',
    authStartSupport: 'cliproxy-cli',
  ...
  opencode: {
    ...
    description: 'OpenCode/Zen completion models (API key only)',
    oauthFlow: 'device_code',
    callbackPort: null,
    callbackProviderName: 'opencode',
    authUrlProviderName: 'opencode',
    refreshOwnership: 'unsupported',
    authStartSupport: 'unsupported',
    authStartUnsupportedReason:
      'OpenCode Zen uses API key authentication. Configure via AI Providers with your OpenCode API key from https://opencode.ai/auth',
    authFilePrefixes: ['opencode-'],
    tokenTypeValues: ['opencode'],
    aliases: ['zen'],
  },
  'opencode-go': {
    displayName: 'OpenCode Go',
    description: 'OpenCode Go completion models (API key only)',
    oauthFlow: 'device_code',
    callbackPort: null,
    callbackProviderName: 'opencode-go',
    authUrlProviderName: 'opencode-go',
    refreshOwnership: 'unsupported',
    authStartSupport: 'unsupported',
    authStartUnsupportedReason:
      'OpenCode Go uses API key authentication. Configure via AI Providers with your OpenCode API key from https://opencode.ai/auth',
    authFilePrefixes: ['opencode-go-'],
    tokenTypeValues: ['opencode-go'],
    aliases: [],
  },
  poolside: {
    displayName: 'Poolside',
    description: 'Poolside AI inference models (API key only)',
    oauthFlow: 'device_code',
    callbackPort: null,
    callbackProviderName: 'poolside',
    authUrlProviderName: 'poolside',
    refreshOwnership: 'unsupported',
    authStartSupport: 'unsupported',
    authStartUnsupportedReason:
      'Poolside uses API key authentication. Configure via AI Providers with your Poolside API key from https://poolside.ai',
    authFilePrefixes: ['poolside-'],
    tokenTypeValues: ['poolside'],
    aliases: [],
  },
  agy: {
