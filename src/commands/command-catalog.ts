    ...
    summary:
      {
        ...
        zai: 'Z.AI GLM via CLIProxy OAuth',
        opencode: 'OpenCode Zen via CLIProxy API key',
        'opencode-go': 'OpenCode Go via CLIProxy API key',
        poolside: 'Poolside AI via CLIProxy API key',
